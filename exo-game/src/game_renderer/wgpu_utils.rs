use crate::game_renderer::assets_manager::AssetManager;
use std::sync::Arc;
use wgpu::{
...
pub fn build_rendering_pipeline(
    ...
    // Index 0: The Texture/Sampler (Global to the Atlas)
    // Index 1: The SpriteRegion (The specific UV window)
    let pipeline_layout = device.create_pipeline_layout(&PipelineLayoutDescriptor {
        label: Some("Sprite Pipeline Layout"),
        bind_group_layouts: &[
            Some(&asset_manager.layout),           // Group 0
            Some(&asset_manager.instances.layout), // Group 1
            Some(&asset_manager.camera.layout),    // Group 2
        ],
        immediate_size: 0,
    });
    ...
    device.create_render_pipeline(&RenderPipelineDescriptor {
        ...
        vertex: VertexState {
            ...
            buffers: &[], // We are using hardcoded vertices + Uniforms for now
        ...
        fragment: Some(FragmentState {
            ...
            targets: &[Some(ColorTargetState {
                ...
                // Production-ready Alpha Blending
                blend: Some(BlendState::ALPHA_BLENDING),
                write_mask: ColorWrites::ALL,
            })],
            compilation_options: Default::default(),
        }),
        // Define how the GPU interprets the vertices
