...
use zoea_engine::rendering::assets::{AssetId, Sprite};
use zoea_engine::rendering::uv_rectangle::UvRectangle;
use zoea_engine::rotation::Rotation;
use zoea_engine::scene::Scene;
use zoea_engine::transform::{Position, Scale, Transform};
use zoea_engine::TempEntity;

fn main() {
    let mut engine = GameEngine::default();

    let mut atlas = Atlas::new("./assets/terrain_tiles_v2.png", UvRectangle::from_size(320.0, 512.0));
